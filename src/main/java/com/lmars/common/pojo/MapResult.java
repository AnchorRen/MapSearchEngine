...
public class MapResult {
    ...
    public static MapResult build(Integer status, String msg, Object data) {
        return new MapResult(status, msg, data);
    }
    ...
    public MapResult(Integer status, String msg, Object data) {
        this.status = status;
        this.msg = msg;
        this.data = data;
    }
...
//    }
    ...
    /**
     * 将json结果集转化为MapResult对象
     * 
     * @param jsonData json数据
     * @param clazz MapResult中的object类型
     * @return
     */
    public static MapResult formatToPojo(String jsonData, Class<?> clazz) {
        try {
            if (clazz == null) {
                return MAPPER.readValue(jsonData, MapResult.class);
            }
