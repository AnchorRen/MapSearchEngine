                        ...
                        <div id="layer_table">
                           ...
                           <c:forEach items="${mapInfo.layers}" var="layer">
	                            <div id="${layer.title }" class="${layer.layerId%2==0?'even':'odd'}">
	                               ...
	                               <div id="images">
	                               		<img class="layer_img"  src="../../images/arcgis/${layer.id}/${layer.id}_1.png">
								        <img class="layer_img"  src="../../images/arcgis/${layer.id}/${layer.id}_2.png">
								        <img class="layer_img"  src="../../images/arcgis/${layer.id}/${layer.id}_3.png">
	                               </div>
	                            </div>
                            </c:forEach>
                        </div>
