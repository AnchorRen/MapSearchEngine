		...
		<div class="navbar navbar-default header">
			<div class="container-fluid">
				<!-- <div class="row"> -->
					...
					<form class="navbar-form navbar-left" action="/q" role="search" method="get"
						style="margin-left: 20px;">
						<div class="input-group">
							<input type="text" class="form-control" placeholder="Search" name="keywords" aria-describedby="btn-search" id="key" value="${query}">
